...
//Get Position to check where Player is on the board
int Player2::getPos(){
    return pos;
}
...
//Set Wins if player reaches spot 100
...
//Reset the position for new game
void Player2::reset(){
    pos=0;
}
        
//Get Number of Wins for stats
int Player2::getWins(){
    return wins;
}
    
//Get the Players Name for Stats File
